<template>
    <div v-if="!authUserStatus" class="bg-white h-12 px-4 flex items-center border-b border-gray-400 shadow-sm">
        <div class="w-1/3">
            <div class="flex">
                <router-link to="/">
        ...
        <div class="w-1/3 flex justify-center items-center h-full">
            ...
            <router-link :to="'/users/' + authUser.data.user_id"
                ...
                <img src="/images/profile.jpg" alt="profile image for user" class="w-8 h-8 object-cover rounded-full">
            </router-link>
